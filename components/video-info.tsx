...
export function VideoInfo({ metadata }: VideoInfoProps) {
  ...
  return (
    <div className="youtube-card animate-scale-in overflow-hidden border-2 border-white/10 hover:border-white/20 transition-all duration-300">
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="relative flex-shrink-0 lg:w-96 group">
          <div className="relative overflow-hidden bg-gradient-to-br from-youtube-dark to-surface-secondary">
            ...
            <div className="relative p-4 sm:p-6 space-y-4 bg-gradient-to-b from-black/60 via-black/80 to-black/95 backdrop-blur-sm">
              ...
              <div className="relative z-10 flex items-center justify-between gap-3 mb-4">
                <div className="flex items-center gap-2 flex-wrap">
                  <div className="flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-white/15 to-white/10 backdrop-blur-md rounded-xl border border-white/20 shadow-lg hover:scale-105 transition-all duration-300 group">
                    <div className="relative">
                      <Clock className="h-4 w-4 text-white group-hover:text-youtube-red transition-colors duration-300" />
                    ...
                    <span className="text-sm font-mono text-white font-medium tracking-wide">{formatDuration(metadata.duration)}</span>
                  </div>
                  
                  <div className="flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-white/15 to-white/10 backdrop-blur-md rounded-xl border border-white/20 shadow-lg hover:scale-105 transition-all duration-300 group">
                    <div className="relative">
                      <Eye className="h-4 w-4 text-white group-hover:text-success-400 transition-colors duration-300" />
                    ...
                    <span className="text-sm font-medium text-white">{formatViewCount(metadata.view_count)}</span>
                  </div>
                </div>
              ...
              <div className="relative z-10 space-y-3 group cursor-default">
                <h3 className="text-base sm:text-lg font-bold text-white line-clamp-2 leading-tight group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-youtube-red group-hover:via-white group-hover:to-youtube-red group-hover:bg-clip-text transition-all duration-500">
                  {metadata.title}
                </h3>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <span className="text-sm text-gray-200 font-medium truncate block hover:text-white transition-colors duration-300">{metadata.uploader}</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <div className="w-1.5 h-1.5 bg-success-400 rounded-full animate-pulse"></div>
                    <span className="text-xs text-success-400 font-semibold tracking-wide">Verified</span>
                  </div>
                </div>
              </div>
              
              {/* Beautiful Interactive Action Buttons */}
              <div className="relative z-10 flex gap-2 sm:gap-3 pt-2">
                <div className="flex-1 group">
                  <div className="relative overflow-hidden px-3 sm:px-4 py-2.5 bg-gradient-to-r from-youtube-red/25 via-youtube-red/20 to-youtube-red-hover/25 border border-youtube-red/40 rounded-xl backdrop-blur-md transition-all duration-300 cursor-pointer hover:border-youtube-red/60 hover:shadow-lg hover:shadow-youtube-red/20">
                    ...
                    <div className="relative flex items-center justify-center gap-2">
                      ...
                      <span className="text-xs sm:text-sm font-semibold text-youtube-red group-hover:text-white transition-colors duration-300">Preview</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex-1 group">
                  <div className="relative overflow-hidden px-3 sm:px-4 py-2.5 bg-gradient-to-r from-info-500/25 via-info-500/20 to-info-600/25 border border-info-500/40 rounded-xl backdrop-blur-md transition-all duration-300 cursor-pointer hover:border-info-500/60 hover:shadow-lg hover:shadow-info-500/20">
                    ...
                    <div className="relative flex items-center justify-center gap-2">
                      ...
                      <span className="text-xs sm:text-sm font-semibold text-info-400 group-hover:text-white transition-colors duration-300">Details</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative z-10 flex flex-wrap gap-2 pt-2">
                <div className="flex items-center gap-1.5 px-2.5 py-1.5 bg-gradient-to-r from-success-500/20 to-success-600/20 border border-success-500/30 rounded-lg backdrop-blur-sm hover:scale-105 transition-all duration-300">
                  ...
                  <span className="text-xs font-semibold text-success-300">Ready</span>
                </div>
                ...
                {metadata.streams.filter(stream => stream.type === 'audio').length > 0 && (
                  <div className="flex items-center gap-1.5 px-2.5 py-1.5 bg-gradient-to-r from-warning-500/20 to-warning-600/20 border border-warning-500/30 rounded-lg backdrop-blur-sm hover:scale-105 transition-all duration-300">
                    ...
                    <span className="text-xs font-semibold text-warning-300">Audio</span>
                  </div>
                )}
              </div>
              ...
              <div className="relative z-10 pt-3 border-t border-white/10">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs font-medium text-gray-300">Download Status</span>
                  <span className="text-xs font-bold text-success-400">Ready to Start</span>
                </div>
        ...
        <div className="flex-1 p-6 lg:p-8 space-y-6">
          ...
          <div className="space-y-4">
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-serif font-bold text-white leading-tight line-clamp-3 hover:line-clamp-none transition-all duration-300 cursor-default">
              {metadata.title}
            </h2>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-lg sm:text-xl font-semibold text-white truncate">{metadata.uploader}</p>
                <p className="text-sm text-gray-400">Video Creator</p>
              </div>
              <div className="text-right">
                <p className="text-sm font-medium text-success-400">Verified</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="glass-card p-4 rounded-xl border border-white/10 hover:border-info-500/30 transition-all duration-300 group">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-xs text-gray-400 uppercase tracking-wide font-medium">Duration</p>
                    <p className="text-lg font-bold text-white">{formatDuration(metadata.duration)}</p>
                  </div>
                </div>
              </div>
            )}
            ...
            {metadata.view_count > 0 && (
              <div className="glass-card p-4 rounded-xl border border-white/10 hover:border-success-500/30 transition-all duration-300 group">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-xs text-gray-400 uppercase tracking-wide font-medium">Views</p>
                    <p className="text-lg font-bold text-white">{formatViewCount(metadata.view_count)}</p>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="glass-card p-4 rounded-xl border border-white/10 hover:border-youtube-red/30 transition-all duration-300 group">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-xs text-gray-400 uppercase tracking-wide font-medium">Formats</p>
                  <p className="text-lg font-bold text-white">{metadata.streams.length} available</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-3">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-success-500/20 to-success-600/20 border border-success-500/30 rounded-full backdrop-blur-sm">
              ...
              <span className="text-sm font-medium text-success-300">Ready to Download</span>
            </div>
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-info-500/20 to-info-600/20 border border-info-500/30 rounded-full backdrop-blur-sm">
              ...
              <span className="text-sm font-medium text-info-300">Multiple Qualities</span>
            </div>
            ...
            {metadata.streams.some(stream => stream.type === 'audio') && (
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-warning-500/20 to-warning-600/20 border border-warning-500/30 rounded-full backdrop-blur-sm">
                <span className="text-sm font-medium text-warning-300">Audio Available</span>
              </div>
            )}
          </div>
          ...
          <div className="glass-card border border-white/10 rounded-xl p-5 bg-gradient-to-r from-youtube-red/5 via-transparent to-success-500/5">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <p className="text-lg font-semibold text-white mb-1">Ready for Download</p>
                <p className="text-sm text-gray-400">Choose your preferred download method below to get started</p>
              </div>
              <div className="flex items-center gap-2">
